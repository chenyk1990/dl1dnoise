...
% Revised:     Jan, 2023
% This script takes about 3-5 minutes
% 
...
print(gcf,'-depsc','-r300','fig9a.eps');
print(gcf,'-dpng','-r300','fig9a.png');
...
print(gcf,'-depsc','-r300','fig9b.eps');
print(gcf,'-dpng','-r300','fig9b.png');
