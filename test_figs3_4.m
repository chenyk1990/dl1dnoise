...
tic
d3=yc_bp(dn,0.004,0,0.1,40,45,0);
toc

inds=50:151;%because the SNR is not always the best metric
yc_snr(dc(inds,:),dn(inds,:))
yc_snr(dc(inds,:),d1(inds,:))
yc_snr(dc(inds,:),d11(inds,:))
yc_snr(dc(inds,:),d2(inds,:))
yc_snr(dc(inds,:),d3(inds,:))
...
subplot(3,4,1:2);yc_wigb([rvz,rvx,rvy],1,1:36,t(:),clip);%title('Vz');ylabel('Time (s)');%xlabel('Channel');
...
subplot(3,4,3:4);yc_wigb(dn,1,1:36,t(:),clip);%title('Vz');ylabel('Time (s)');%xlabel('Channel');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');
...
subplot(3,4,5:6);yc_wigb(d3,1,1:36,t(:),clip);%title('Vz');ylabel('Time (s)');%xlabel('Channel');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');
ylabel('Time (s)','Fontsize',12,'fontweight','normal');
...
subplot(3,4,7:8);yc_wigb(d2,1,1:36,t(:),clip);%title('Vz');ylabel('Time (s)');%xlabel('Channel');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');
...
subplot(3,4,9:10);yc_wigb(d1,1,1:36,t(:),clip);%title('Vz');ylabel('Time (s)');%xlabel('Channel');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');
ylabel('Time (s)','Fontsize',12,'fontweight','normal');
...
subplot(3,4,11:12);yc_wigb(d11,1,1:36,t(:),clip);%title('Vz');ylabel('Time (s)');%xlabel('Channel');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');
xlabel('Channel','Fontsize',12,'fontweight','normal');
...
% 
% figure('units','normalized','Position',[0.2 0.4 0.5, 1],'color','w');
% subplot(3,6,1:2);yc_wigb(d2(:,1:12),1,x,t,clip);title('Vz');ylabel('Time (s)');%xlabel('Channel');
% subplot(3,6,3:4);yc_wigb(d2(:,13:24),1,x,t,clip);title('Vx');set(gca,'ytick',[]);%xlabel('Channel');
% subplot(3,6,5:6);yc_wigb(d2(:,25:36),1,x,t,clip);title('Vy');set(gca,'ytick',[]);%xlabel('Channel');
% 
% subplot(3,6,7:8);yc_wigb(d1(:,1:12),1,x,t,clip);xlabel('Channel');title('Vz');ylabel('Time (s)');
% subplot(3,6,9:10);yc_wigb(d1(:,13:24),1,x,t,clip);xlabel('Channel');title('Vx');set(gca,'ytick',[])
% subplot(3,6,11:12);yc_wigb(d1(:,25:36),1,x,t,clip);xlabel('Channel');title('Vy');set(gca,'ytick',[])
% 
% subplot(3,6,13:14);yc_wigb(d11(:,1:12),1,x,t,clip);xlabel('Channel');title('Vz');ylabel('Time (s)');
% subplot(3,6,15:16);yc_wigb(d11(:,13:24),1,x,t,clip);xlabel('Channel');title('Vx');set(gca,'ytick',[])
% subplot(3,6,17:18);yc_wigb(d11(:,25:36),1,x,t,clip);xlabel('Channel');title('Vy');set(gca,'ytick',[])
...
% print(gcf,'-depsc','-r300','fig222.eps');
