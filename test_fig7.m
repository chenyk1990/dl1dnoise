...
figure;yc_imagesc([dc,dn1]);

X=yc_patch(dn1,1,l1,1,l1/2,1);
param.T=K;      %sparsity level
param.D=D;    %initial D
param.niter=30; %number of K-SVD iterations to perform; default: 10
param.mode=1;   %1: sparsity; 0: error
...
Gksvd=yc_pthresh(Gksvd0,'ph',ph);
X1=Dksvd*Gksvd;
d11=yc_patch_inv(X1,1,n1,n2,l1,1,l1/2,1);
figure;yc_imagesc([dn1,d11,dn1-d11]);
yc_snr(dc,dn1)
yc_snr(dc,d11)
...
figure;yc_imagesc([dc,dn2]);

X=yc_patch(dn2,1,l1,1,l1/2,1);
param.T=K;      %sparsity level
param.D=D;    %initial D
param.niter=30; %number of K-SVD iterations to perform; default: 10
param.mode=1;   %1: sparsity; 0: error
...
Gksvd=yc_pthresh(Gksvd0,'ph',ph);
X1=Dksvd*Gksvd;
d22=yc_patch_inv(X1,1,n1,n2,l1,1,l1/2,1);
figure;yc_imagesc([dn2,d22,dn2-d22]);
yc_snr(dc,dn2)
yc_snr(dc,d22)

%% level 3
dn3=dc+0.06*randn(size(dc));
figure;yc_imagesc([dc,dn3]);

X=yc_patch(dn3,1,l1,1,l1/2,1);
param.T=K;      %sparsity level
param.D=D;    %initial D
param.niter=30; %number of K-SVD iterations to perform; default: 10
param.mode=1;   %1: sparsity; 0: error
...
Gksvd=yc_pthresh(Gksvd0,'ph',ph);
X1=Dksvd*Gksvd;
d33=yc_patch_inv(X1,1,n1,n2,l1,1,l1/2,1);
figure;yc_imagesc([dn3,d33,dn3-d33]);
yc_snr(dc,dn3)
yc_snr(dc,d33)
...
subplot(3,3,1);yc_imagesc([dn1],0.2,2,x,t);ylabel('Time (s)','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');
...
subplot(3,3,2);yc_imagesc([dn2],0.2,2,x,t);set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');%ylabel('Time (s)','Fontsize',12,'fontweight','normal');
...
subplot(3,3,3);yc_imagesc([dn3],0.2,2,x,t);set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');%ylabel('Time (s)','Fontsize',12,'fontweight','normal');
...
subplot(3,3,4);yc_imagesc(d11,0.2,2,x,t);ylabel('Time (s)','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');
...
subplot(3,3,5);yc_imagesc(d22,0.2,2,x,t);set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');
...
subplot(3,3,6);yc_imagesc(d33,0.2,2,x,t);set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');
...
subplot(3,3,7);yc_imagesc(dn1-d11,0.2,2,x,t);ylabel('Time (s)','Fontsize',12,'fontweight','normal');xlabel('Channel','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');
...
subplot(3,3,8);yc_imagesc(dn2-d22,0.2,2,x,t);xlabel('Channel','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');
...
subplot(3,3,9);yc_imagesc(dn3-d33,0.2,2,x,t);xlabel('Channel','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');
